...
public class FiCitasDB {
    ...
    static {
        ...
        citas.add(new Cita(1, 1, "Terapia Física", "Consultorio 1", "2026-12-01", "10:00", 60, "CITA-001", "Pendiente"));
        citas.add(new Cita(2, 2, "Rehabilitación", "Consultorio 2", "2026-12-01", "11:00", 45, "CITA-002", "Pendiente"));
        citas.add(new Cita(3, 1, "Terapia Física", "Consultorio 1", "2026-12-02", "09:00", 60, "CITA-003", "Pendiente"));
    }
}

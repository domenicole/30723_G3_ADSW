...
public class VistaPacientes extends JFrame {
    ...
    public VistaPacientes(GestorEventos gestor, Usuario u, Perfil p) {
        ...
        // Contenedor principal para la pestaña de Pacientes
        ...
        JPanel panelNorteForm = new JPanel(new BorderLayout());
        panelNorteForm.add(panelForm, BorderLayout.CENTER);
        panelNorteForm.add(pnlBotones, BorderLayout.SOUTH);
        
        panelPacientes.add(panelNorteForm, BorderLayout.NORTH);

        // Contenedor para pestaña Citas
        VistaCitas panelCitas = new VistaCitas(gestor, u, p);
        ...
        pestañas.addTab("Gestión de Pacientes", panelPacientes);
        pestañas.addTab("Gestión de Citas", panelCitas);
